...
> Skills globais ficam em `~/.nerion/skills/` e funcionam em qualquer projeto.
> Skills locais ficam em `.nerion/skills/` e so funcionam nesse projeto.
...
**Fonte:** Skill validada pelo NERION OS
...
**Como instalar:** Ja vem nativo no Codex. Chamar com `/frontend-design`
...
**Como instalar:** Ja vem nativo no Codex. Chamar com `/canvas-design`
**Fonte:** Skill nativa do Codex
...
**Como instalar:** Ja vem nativo no Codex. Chamar com `/pdf`
**Fonte:** Skill nativa do Codex
...
**Como instalar:** Ja vem nativo no Codex. Chamar com `/docx`
**Fonte:** Skill nativa do Codex
...
**Como instalar:** Ja vem nativo no Codex. Chamar com `/pptx`
**Fonte:** Skill nativa do Codex
...
**Como instalar:** Ja vem nativo no Codex. Chamar com `/xlsx`
**Fonte:** Skill nativa do Codex
...
**Como instalar:** Ja vem nativo no Codex. Chamar com `/doc-coauthoring`
**Fonte:** Skill nativa do Codex
...
**Como instalar:** Ja vem nativo no Codex. Chamar com `/webapp-testing`
**Fonte:** Skill nativa do Codex
...
**Como instalar:** Ja vem nativo no Codex. Chamar com `/skill-creator`
**Fonte:** Skill nativa do Codex
