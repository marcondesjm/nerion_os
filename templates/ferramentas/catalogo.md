...
Pra verificar quais MCPs ja estao instalados: `codex mcp list`
Pra remover um MCP: `codex mcp remove nome-do-mcp`
...
**Como instalar:**
```bash
codex mcp add gmail -- npx -y @gongrzhe/server-gmail-autoauth-mcp
```
...
**Como instalar:**
```bash
codex mcp add google-calendar -- npx -y @gongrzhe/server-google-calendar-autoauth-mcp
```
...
**Como instalar:**
```bash
codex mcp add canva -- npx -y @canva/canva-mcp-server
```
...
**Como instalar:**
```bash
codex mcp add n8n -- npx -y n8n-mcp
```
