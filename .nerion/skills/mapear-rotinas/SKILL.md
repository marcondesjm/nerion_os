...
description: >
  ...
  skills concretas e cria as aprovadas em `.nerion/skills/`. Use quando o usuário pedir
...
Ler `templates/skills/catalogo.md` pra ver se alguma das tarefas mencionadas já é coberta por uma skill nativa do Codex ou validada pelo NERION OS. Se sim, sugerir a skill existente em vez de criar uma nova:
...
1. Criar pasta `.nerion/skills/<nome>/`
...
```
Criei [N] skills:
✓ /<nome1> — em .nerion/skills/<nome1>/SKILL.md
✓ /<nome2> — em .nerion/skills/<nome2>/SKILL.md
...
