...
description: >
  ...
  `estrategia.md`, `NERION-OS.md`, `identidade/design-guide.md`) que ficaram desatualizados em relação
...
- Skills em `.nerion/skills/` — quais existem hoje
...
- **Em `NERION-OS.md`:** as regras de organização e a estrutura de pastas listada batem com o que existe?
...
2. NERION-OS.md — tem regra "propostas vão em propostas/" mas vejo propostas em clientes/<x>/propostas/
