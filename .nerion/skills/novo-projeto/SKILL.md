...
name: novo-projeto
description: >
  Cria uma pasta de projeto nova com `NERION-OS.md` dedicado, depois de uma entrevista curta sobre
...
Quando o usuário começa um projeto novo (cliente, iniciativa, produto), cria uma pasta com `NERION-OS.md` próprio que herda contexto da raiz e adiciona o que é específico do projeto.
...
- **Cliente novo:** criar em `clientes/<Nome>/` (ou na pasta equivalente do perfil — ler `NERION-OS.md` da raiz pra confirmar a convenção)
...
- `NERION-OS.md` do projeto (instruções herdadas + específicas)
...
### Passo 4 — Conteúdo do `NERION-OS.md` do projeto
...
✓ NERION-OS.md do projeto
✓ briefing.md
✓ Subpastas: [lista]

Quando for trabalhar nesse projeto, abre o terminal já dentro da pasta — assim eu carrego o NERION-OS.md específico junto com o da raiz.
```
